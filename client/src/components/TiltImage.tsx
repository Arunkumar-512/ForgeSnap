  ...
  return (
    ...
    >
      ...
      >
        <motion.img
          src="/hero_img1.png"
          className="border-b border-indigo-500/30 bg-linear-180 from-indigo-600/40 to-transparent p-1 w-full rounded-[15px] will-change-transform transform-[translateZ(0)]"
