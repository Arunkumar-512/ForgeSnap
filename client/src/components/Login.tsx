    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center">
        ...
        >
          ...
          <button
            type="submit"
            className="mt-2 w-full h-11 rounded-full text-white bg-indigo-600 hover:bg-violet-600 transition"
          >
            {state === "login" ? "Login" : "Sign up"}
          </button>
          ...
          <p
            ...
            className="text-zinc-400 text-sm mt-3 mb-11 cursor-pointer"
          >
            {state === "login"
